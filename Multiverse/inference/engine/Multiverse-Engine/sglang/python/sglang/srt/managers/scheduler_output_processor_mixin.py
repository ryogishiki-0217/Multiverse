...
from sglang.srt.managers.schedule_batch import BaseFinishReason, Req, ScheduleBatch, FINISH_MATCHED_GOAL_TOKEN, FINISH_MATCHED_PATH_TOKEN
...
class SchedulerOutputProcessorMixin:
    ...
    def stream_output_generation(
        ...
        for req in reqs:
            ...
            if (
                (req.finished() and not isinstance(req.finished_reason, FINISH_MATCHED_GOAL_TOKEN))
